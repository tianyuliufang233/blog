...
services:
  ...
  coredns:
    ...
    ports:
      - "53:53/udp"
    volumes:
      - ./coredns.conf:/etc/coredns/coredns.conf:ro
...
[coredns 配置https://www.cnblogs.com/netonline/p/9953921.html](https://www.cnblogs.com/netonline/p/9953921.html)  
